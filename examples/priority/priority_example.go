...
func main() {
	...
	if err := cfg1.Execute(os.Args); err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
	...
	if err := cfg2.Execute(os.Args); err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
	...
	if err := cfg3.Execute(os.Args); err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
	...
	if err := cfg4.Execute(os.Args); err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
	...
	if err := cfg5.Execute(os.Args); err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
